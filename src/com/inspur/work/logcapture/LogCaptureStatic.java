...
public class LogCaptureStatic {
	...
	public interface LogCaptureStateListen{
...
//	    if (!file.exists()) {
//	        TR069Log.say("No content to logcat! \n");
//	        if(listen != null)
//			{
//				listen.onErrorState();
//			}
...
//	}
	...
	private static String[] getCMD(String logcatCmd, String filePath ,int iLogType)
	{
	...
	private static String[] getCMDApend(String logcatCmd, String filePath)
	{
		String saveFileLocal = filePath.substring(0, filePath.lastIndexOf("/"));
		String c0 = "mkdir -p " + saveFileLocal;
